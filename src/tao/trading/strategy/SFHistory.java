...
public class SFHistory implements EWrapper
{
	...
	public static void main(String[] args)
	{
		...
		String historyReqDate2 = args[4];
		
		SFHistory open = new SFHistory(port, ib_id, trademarket);
       	open.run(trademarket, historyReqDate, historyReqDate2);
	}

	
	public void run( String trade_market, String historyReqDate, String historyReqDate2) {
		...
		try
		{
			...
			//String historyReqDate2 = getNextDate(historyReqDate);
			
			// TOCHANGE 3
			// reset everything for real time
			//currentTime = historyReqDate + " 13:00:00";
			currentTime = historyReqDate2 + " 16:00:00";
	...
	public SFHistory( int port, String ib_id, String trade_market )
	{
		// create a logger
		try
		{
