...
public class SF108a extends SF implements EWrapper
{
	...
	protected SF108aTradeManager[][] tradeManager;
	...
	public static void main(String[] args)
	{
		...
		if ( "Test".equalsIgnoreCase(args[0]))
    	{
    		...
    		open = new SF108a(account, port, conn_id, market, Constants.TEST_MODE, lot1, lot2, lot3, null);
    	...
    	{	
    		...
    		open = new SF108a(account, port, conn_id, market, Constants.REAL_MODE, lot1, lot2, lot3, logdir);
    		open.run();
	...
	public SF108a( String account, int port, String ib_id, String trade_market, int mode, int lot1, int lot2, int lot3, String outputdir)
	{
		...
		if ("EUR".equalsIgnoreCase(trade_market))
		{	
			TOTAL_SYMBOLS = 15;
			initialize();
			createContract(  0, 500, "EUR", "CASH", "IDEALPRO", "USD", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  1, 501, "EUR", "CASH", "IDEALPRO", "JPY", true,  lot2,   0.01, 20, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract(  2, 502, "EUR", "CASH", "IDEALPRO", "CAD", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  3, 503, "EUR", "CASH", "IDEALPRO", "GBP", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  4, 504, "EUR", "CASH", "IDEALPRO", "CHF", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  5, 505, "EUR", "CASH", "IDEALPRO", "NZD", false, lot2, 0.0001, 20, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  6, 506, "EUR", "CASH", "IDEALPRO", "AUD", false, lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  7, 507, "GBP", "CASH", "IDEALPRO", "AUD", false, lot1, 0.0001, 22, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  8, 508, "GBP", "CASH", "IDEALPRO", "NZD", false, lot1, 0.0001, 22, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  9, 509, "GBP", "CASH", "IDEALPRO", "USD", true,  lot1, 0.0001, 22, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract( 10, 510, "GBP", "CASH", "IDEALPRO", "CAD", true,  lot1, 0.0001, 22, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract( 11, 511, "GBP", "CASH", "IDEALPRO", "CHF", true,  lot1, 0.0001, 22, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract( 12, 512, "GBP", "CASH", "IDEALPRO", "JPY", true,  lot1,   0.01, 22, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 13, 513, "CHF", "CASH", "IDEALPRO", "JPY", false, lot3,   0.01, 18, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 14, 514, "USD", "CASH", "IDEALPRO", "JPY", false, lot2,   0.01, 20, Constants.PRICE_TYPE_2,20,30,40,50);
		}
		else if ("JPY".equalsIgnoreCase(trade_market))
		{
			TOTAL_SYMBOLS = 10;
			initialize();
			createContract(  1, 501, "EUR", "CASH", "IDEALPRO", "JPY", true,  lot2,   0.01, 21, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract(  5, 505, "EUR", "CASH", "IDEALPRO", "NZD", false, lot2, 0.0001, 21, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  6, 506, "EUR", "CASH", "IDEALPRO", "AUD", false, lot2, 0.0001, 21, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract( 12, 512, "GBP", "CASH", "IDEALPRO", "JPY", true,  lot1,   0.01, 23, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract(  7, 507, "GBP", "CASH", "IDEALPRO", "AUD", false, lot1, 0.0001, 23, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  8, 508, "GBP", "CASH", "IDEALPRO", "NZD", false, lot1, 0.0001, 23, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract( 13, 513, "CHF", "CASH", "IDEALPRO", "JPY", false, lot3,   0.01, 19, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 14, 514, "USD", "CASH", "IDEALPRO", "JPY", false, lot2,   0.01, 25, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 17, 517, "CAD", "CASH", "IDEALPRO", "JPY", true,  lot2,   0.01, 20, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 18, 518, "AUD", "CASH", "IDEALPRO", "USD", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
		}
		else if ("USD".equalsIgnoreCase(trade_market))
		{	
			TOTAL_SYMBOLS = 17;
			initialize();
			createContract(  0, 500, "EUR", "CASH", "IDEALPRO", "USD", true,  lot2, 0.0001, 25, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  1, 501, "EUR", "CASH", "IDEALPRO", "JPY", true,  lot2,   0.01, 25, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract(  2, 502, "EUR", "CASH", "IDEALPRO", "CAD", true,  lot2, 0.0001, 25, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  3, 503, "EUR", "CASH", "IDEALPRO", "GBP", true,  lot2, 0.0001, 25, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  4, 504, "EUR", "CASH", "IDEALPRO", "CHF", true,  lot2, 0.0001, 25, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  5, 505, "EUR", "CASH", "IDEALPRO", "NZD", false, lot2, 0.0001, 25, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  6, 506, "EUR", "CASH", "IDEALPRO", "AUD", false, lot2, 0.0001, 25, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  7, 507, "GBP", "CASH", "IDEALPRO", "AUD", false, lot1, 0.0001, 30, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract(  8, 508, "GBP", "CASH", "IDEALPRO", "NZD", false, lot1, 0.0001, 30, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract(  9, 509, "GBP", "CASH", "IDEALPRO", "USD", true,  lot1, 0.0001, 30, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract( 10, 510, "GBP", "CASH", "IDEALPRO", "CAD", true,  lot1, 0.0001, 30, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract( 11, 511, "GBP", "CASH", "IDEALPRO", "CHF", true,  lot1, 0.0001, 30, Constants.PRICE_TYPE_4,20,30,40,50);
			createContract( 12, 512, "GBP", "CASH", "IDEALPRO", "JPY", true,  lot1,   0.01, 30, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 13, 513, "CHF", "CASH", "IDEALPRO", "JPY", false, lot3,   0.01, 25, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 14, 514, "USD", "CASH", "IDEALPRO", "JPY", false, lot2,   0.01, 25, Constants.PRICE_TYPE_2,20,30,40,50);
			createContract( 15, 515, "USD", "CASH", "IDEALPRO", "CAD", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_3,20,30,40,50);
			createContract( 16, 516, "USD", "CASH", "IDEALPRO", "CHF", true,  lot2, 0.0001, 20, Constants.PRICE_TYPE_4,20,30,40,50);
		}


		prevData = new QuoteData[TOTAL_SYMBOLS];
		if (( SYSTEM_RUNNING_MODE == Constants.REAL_MODE ) || ( SYSTEM_RUNNING_MODE == Constants.RECORD_MODE )) 
        {
			m_client.eConnect("127.0.0.1" , port, new Integer(IB_ID));
			m_client.setServerLogLevel(5);
			logger.warning("SF108a started in " + SYSTEM_RUNNING_MODE + " mode at port " + port);
        }
			...
			int volume, int count, double WAP, boolean hasGaps)
	{
		...
		if (( SYSTEM_RUNNING_MODE == Constants.RECORD_MODE ) || ( SYSTEM_RUNNING_MODE == Constants.REAL_MODE )) 
		...
		if (( historySaved == false) && (( SYSTEM_RUNNING_MODE == Constants.REAL_MODE ) || ( SYSTEM_RUNNING_MODE == Constants.RECORD_MODE )))
		{
			for ( int i = 0; i < TOTAL_SYMBOLS; i++)
			...
			long volume, double wap, int count)
	{
		...
		if ((( SYSTEM_RUNNING_MODE == Constants.REAL_MODE )||( SYSTEM_RUNNING_MODE == Constants.RECORD_MODE )) && !timeout )
			saveRealTimeData(reqId + "," + time + "," + open + "," + high + "," + low + "," + close + "," + volume + "," + wap + "," + count);
		
		if ( SYSTEM_RUNNING_MODE == Constants.RECORD_MODE )
			return;
		...
		for ( int i = 0; i < TOTAL_SYMBOLS; i++)
		{
			if (reqId == id_realtime[i])
			{
				...
				if (  inTradingTime(hour, minute) && tradeManager[i][TRADE_5M].trade == null )  
				{
					...
					//tradeManager[i][TRADE_5M].trade = tradeManager[i][TRADE_5M].checkHigherHighLowerLowSetup4( data,tradeManager[i][TRADE_60M].getQuoteData());
				}

				if ( tradeManager[i][TRADE_5M].trade != null )  
				{
					if (inTradingTime(hour, minute) && (tradeManager[i][TRADE_5M].trade.status.equals(Constants.STATUS_OPEN)))
	...
	private void createContract(int idHist, int idReal, String symbol, String type, String exchange, String currency, boolean minuteSupport, int tradeSize, double pipsize, int stopSize, int pricetype, 
			double min1Target1,double min5Target1,double min15Target1,double min60Target1 )
	{
        ...
        id_realtime[totalSymbolIndex] = idReal;
       	...
       	tradeManager[totalSymbolIndex][0] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][0].MODE = this.SYSTEM_RUNNING_MODE;
       	...
       	tradeManager[totalSymbolIndex][1] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][1].MODE = this.SYSTEM_RUNNING_MODE;
       	...
       	tradeManager[totalSymbolIndex][2] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][2].MODE = this.SYSTEM_RUNNING_MODE;
       	...
       	tradeManager[totalSymbolIndex][3] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][3].MODE = this.SYSTEM_RUNNING_MODE;
       	...
       	tradeManager[totalSymbolIndex][4] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][4].MODE = this.SYSTEM_RUNNING_MODE;
       	...
       	tradeManager[totalSymbolIndex][5] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
       	tradeManager[totalSymbolIndex][6] = new SF108aTradeManager(IB_ACCOUNT, m_client,contract, totalSymbolIndex, logger );
	...
	private void initialize()
	{
		...
		tradeManager = new SF108aTradeManager[TOTAL_SYMBOLS][TOTAL_TRADES];	
	...
	private boolean inTradingTime( int hour, int min )
	{
		//return true;
...
// TODO: stop too short causing immutual reversal, expand stop or set limit order to buy/sell at pull back

/*
boolean breaklasthigh = false;
double lastHighPrice = 0;
int lastHighPos = 0;
if ( price < trade.phl_cur.pullBack.high )
{
	if ( lastbar > trade.phl_cur.curPos )
	{
		for ( int i = lastbar - 3; i > trade.phl_cur.curPos +1; i--)
		{
			if ((((QuoteData) quotes[i]).high > ((QuoteData) quotes[i+1]).high) &&
			   (((QuoteData) quotes[i]).high > ((QuoteData) quotes[i+2]).high) &&
			   (((QuoteData) quotes[i]).high > ((QuoteData) quotes[i+3]).high) &&
			   (((QuoteData) quotes[i]).high > ((QuoteData) quotes[i-1]).high) &&
			   (((QuoteData) quotes[i]).high > ((QuoteData) quotes[i-2]).high))
			{
				if ( price > ((QuoteData) quotes[i]).high)
				{
					logger.warning(symbol + " " + CHART + " " + ((QuoteData) quotes[lastbar]).time + " above last none HighLow pull back detected at " + ((QuoteData) quotes[i]).time );
					breaklasthigh = true;
					lastHighPrice = ((QuoteData) quotes[i]).high;
					lastHighPos = i;
				}
				break;
			}
...
if (( price > trade.phl_cur.pullBack.high))// || (breaklasthigh == true ))
{
	double triggerPrice;
	int triggerPos;
	if (breaklasthigh == true )
	{
		logger.warning(symbol + " " + CHART + " trigger by 3/2");
		triggerPrice = lastHighPrice;
		triggerPos = lastHighPos;
	}
	else 
	{
		logger.warning(symbol + " " + CHART + " trigger by pull back");
		triggerPrice = trade.phl_cur.pullBack.high;
		triggerPos = trade.phl_cur.pullBack.pos;
	}
*/
