...
public class GWSupervisor
{
    public GWSupervisor (String userid, String password)
    {
        try
        {
            ...
            new ClassReference("ibgateway.GWClient").startApplication(params);
    ...
    public static void main(String[] args)
    {
        ...
        new GWSupervisor (userid, password);
    }
}
