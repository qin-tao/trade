...
public class SF212TradeManager extends TradeManager2
{
	SF212 mainProgram;
	boolean CNT = false;
    String TIME_ZONE;
	...
	boolean stop_reverse = false;


	
	
	
	public SF212TradeManager()
	{
		super();
	}

	public SF212TradeManager(String account, EClientSocket client, Contract contract, int symbolIndex, Logger logger)
	{
