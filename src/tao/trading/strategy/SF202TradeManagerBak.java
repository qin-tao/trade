...
public class SF202TradeManagerBak extends TradeManager2
{
	SF202Bak mainProgram;
	boolean CNT = false;
    String TIME_ZONE;
...
//	int firstRealTimeDataPosL = 0;
	...
	public SF202TradeManagerBak()
	{
		super();
	}

	public SF202TradeManagerBak(String account, EClientSocket client, Contract contract, int symbolIndex, Logger logger)
	{
...
*/
	...
	public Trade checkBreakOut4a(QuoteData data, double lastTick_bid, double lastTick_ask )
	{
		...
		if ( lastUpPos > lastDownPos)
		{
			...
			prevDownPos = Utility.getLow(quotesL, prevDownPos - 24, prevDownPos).pos;  // make sure it gets the recent low
...
//				trade.lastLargeMoveEnd = lastLargeMoveEnd;
		...
		{	
			...
			prevUpPos = Utility.getHigh(quotesL, prevUpPos - 24, prevUpPos).pos;  // make sure it gets the recent high

		//	System.out.println("lastDown=" + quotesL[lastDownPos].time +  " prev Up Pos=" + quotesL[prevUpPos].time);
