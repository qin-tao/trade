...
public class SFHistoryWeekly1 implements EWrapper
{
	...
	String historyPath="C:/trade/data/history_weekly1/";
	...
	public static void main(String[] args)
	{
		...
		SFHistoryWeekly1 open = new SFHistoryWeekly1(port, ib_id, trademarket);
       	open.run(trademarket, historyReqDate, historyReqDate1 );
	}

	
	public void run( String trade_market, String historyReqDate, String historyReqDate1) {
		...
		try
		{
			...
			logger.info("Real time download finished");
	...
	public SFHistoryWeekly1( int port, String ib_id, String trade_market )
	{
		// create a logger
		try
		{
