...
class SampleFrame extends JFrame implements EWrapper {
    ...
    SampleFrame(String id, String symbol, String type, String market, String currency, String distance ) {
      ...
      getContentPane().add( buttonPanel, BorderLayout.EAST);
    	...
    	/*
    	m_client.eConnect( "127.0.0.1", 7496, 9999);
        ...
        {
        	System.out.println("Can not connect to Tws station");
        }*/
        OrderDlg  m_orderDlg1 = new OrderDlg( this, id, symbol, type, market, currency, distance );
    	m_orderDlg1.show();
