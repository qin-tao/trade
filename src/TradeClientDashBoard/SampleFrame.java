...
class SampleFrame extends JFrame implements EWrapper {
    ...
    SampleFrame(String id, String symbol, String type, String market, String currency ) {
      ...
      getContentPane().add( buttonPanel, BorderLayout.EAST);
        ...
        OrderDlg2  m_orderDlg1 = new OrderDlg2( this, id, symbol, type, market, currency );
    	m_orderDlg1.show();
